  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>Step 6 of 8: Medicine & Daily Alerts</Text>
        <View style={styles.badge}>
          <Text style={styles.badgeText}>Scheduler Coming in Phase 10</Text>
        </View>
      </View>
      ...
      <View style={styles.buttonRow}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}>
          <Text style={styles.primaryButtonText}>Next: Safety →</Text>
        </TouchableOpacity>
      </View>
    </View>
  );

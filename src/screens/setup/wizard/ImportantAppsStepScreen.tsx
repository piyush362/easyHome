  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Important Apps</Text>
        <Text style={styles.subtitle}>Step 4 of 8: Choose Main Apps</Text>
        <View style={styles.badge}>
          <Text style={styles.badgeText}>Picker Coming in Phase 10</Text>
        </View>
      </View>
